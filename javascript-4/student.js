...
let faveColors = ['blue', 'white', 'purple']
...
let me = {
    firstName: 'Francis',
    superHeroName: 'The Pope',
    homeTown: 'The Vatican',
    superPowers: ['Cool hat', 'Fancy ring', 'Thumbs Up'],
    superPowerXP: function () { return Math.floor(Math.random() * 100) + 1 },
    profileImage() {
        return 'http://c2.thejournal.ie/media/2018/03/pope-francis-opens-the-pre-synodal-meeting-of-the-young-390x285.jpg'
    }
}
...
function redactInfo(obj) {
    for (let i  in obj) { obj[i] = 'redacted'
    }
redacted()
}